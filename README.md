...
### Use JOSM GUI
The parser is integrated into JOSMs [IndoorHelper plugin](https://wiki.openstreetmap.org/wiki/JOSM/Plugins/indoorhelper). To use the GUI you need to install [JOSM](https://josm.openstreetmap.de/) and download the IndoorHelper plugin via `Edit` &#8594; `Preferences` &#8594; `Plugins`. Import example:
